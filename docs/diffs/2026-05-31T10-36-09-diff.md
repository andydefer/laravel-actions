...
diff --git a/tests/Integration/Http/ResponseFactoryIntegrationTest.php b/tests/Integration/Http/ResponseFactoryIntegrationTest.php
new file mode 100644
index 0000000..f61a13c
--- /dev/null
+++ b/tests/Integration/Http/ResponseFactoryIntegrationTest.php
@@ -0,0 +1,189 @@
+<?php
+
+declare(strict_types=1);
...
-    }
-}
diff --git a/tests/Unit/Http/ResponseFactoryUnitTest.php b/tests/Unit/Http/ResponseFactoryUnitTest.php
new file mode 100644
index 0000000..4d6b416
--- /dev/null
+++ b/tests/Unit/Http/ResponseFactoryUnitTest.php
@@ -0,0 +1,259 @@
+<?php
+
+declare(strict_types=1);
